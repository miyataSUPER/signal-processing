...
def design_lowpass_filter(cutoff_freq, sampling_freq, filter_order):
    """
    ローパスフィルタを設計する関数
...
def main():
    ...
    try:
        # フィルタを設計
        filter_coefficients = design_lowpass_filter(
